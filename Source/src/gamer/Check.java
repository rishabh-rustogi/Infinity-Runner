...
// Check if the microphone and speech recognition is working properly or not
public class Check{
    float x, y = 15, t=10;      
    double theta =0,cc;
    double rad,s,c;
    ...
    // Define the three image holders (Word not prcessed, Word recognized correctly, Word recognized incorrectly) for (T - This, G - Game, I - Is, A - Aweswome) and 
    Texture TD,TT,TF,GD,GT,GF,ID,IT,IF,AD,AT,AF;
    
    // Define image holders for various images in check page
    ...
    // Update word image based on the how the user speaks
    ...
    void init() throws IOException {
        ...
        // Load images into their image holders
    ...
    // Get bar location based on game time
    ...
    public void renderGL() {
        ...
        // Switch the first word color based on how it was processed
        switch(a[1])
        {
            case 0 : TD.bind();
                     break;
        ...
        // Switch the second word color based on how it was processed
        switch(a[0])
        {
            case 0 : GD.bind();
                     break;
        ...
        // Switch the third word color based on how it was processed
        switch(a[2])
        {
            case 0 : ID.bind();
                     break;
        ...
        // Switch the fourth word color based on how it was processed
        switch(a[3])
        {
            case 0 : AD.bind();
                     break;
        ...
        // Change the circle color quadrant 
        switch(a[0])
        {
        ...
        // Change the bar angle based on game time and voice intensity
        GL11.glColor3f(1.0f, 1.0f, 1.0f);
        GL11.glPushMatrix();
        
            // Calculate the angle and position on the bar
            s=Math.sin(rad);
            c=Math.cos(rad);
            bar.bind();
            GL11.glBegin(GL11.GL_QUADS);
