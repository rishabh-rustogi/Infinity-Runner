...
{
    // Define holders for character movement texture (run, gravity shift, fall)
    ...
    // Initialize the class and load all the images
    void init() throws IOException
    {
        ...
        // Load character images into their holders
    ...
    // Render the character based on which scenario the character is in (run, gravity shift, fall)
    void prender(int stage, double t,double bspeed) throws IOException
    {
        
        // Render based on game time
        if(t-time>=0.24)
        {
            time=t;
            update1++;
        ...
        // Choosing from the various game sates
        switch (stage) {
            case 1:
                runningd();
                break;
    ...
    // Character is simply running straight
    void runningd()
    {
        switch (update1) 
            {
    ...
    // While character is in gravity shift mode
    void shift()
    {
        if(Play.early==1)
        {
    ...
    // When character hits the blade starting and fall down from lower gravity
    ...
    // When character hits the blade starting and fall down from upper gravity
    ...
    // Character is simply running straight but upside down
    void runningu()
    {
        switch (update1) 
            {
