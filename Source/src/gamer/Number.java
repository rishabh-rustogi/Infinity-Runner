...
// Class to render a specific number on the screen for score and highscores
public class Number {
    
    // Image holders for various digits
    ...
    // Load various number images into their holders
    ...
    // Print a specific number using its various digits (one by one)
